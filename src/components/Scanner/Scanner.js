...
const Scanner = () => {
  ...
  // API endpoints
  const API_BASE_URL = process.env.REACT_APP_API_URL || "https://backendspendly-production.up.railway.app";
  const AUTH_API_URL = process.env.REACT_APP_AUTH_URL || "https://backendspendly-production.up.railway.app";
